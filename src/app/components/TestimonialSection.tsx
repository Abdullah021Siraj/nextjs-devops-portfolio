...
export default function TestimonialsSection({
  ...
  return (
    <motion.section
      ...
      className="py-24 md:py-32 px-6 sm:px-8 bg-gradient-to-br from-indigo-50 to-blue-50 overflow-hidden"
      id="testimonials"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center justify-center mb-6 p-3 rounded-full bg-indigo-100">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Feedback from professionals I have had the pleasure to work with on
            various projects.
          </p>
        </motion.div>
        ...
        >
          <Card className="p-8 md:p-10 bg-gradient-to-r from-indigo-600 to-blue-600 border-none text-white max-w-4xl mx-auto">
            ...
            <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
              Lets collaborate to streamline your development workflow, optimize
              your infrastructure, and build reliable, scalable systems.
            </p>
            <motion.div
            ...
            >
              <Button className="px-8 py-6 rounded-xl bg-white text-indigo-600 hover:bg-gray-100 font-semibold shadow-lg text-lg">
